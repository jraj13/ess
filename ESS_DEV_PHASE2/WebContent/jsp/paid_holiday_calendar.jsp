...
<div class="accordion">
			<div class="accordion-section">
				...
				<div id="accordion-1" class="accordion-section-content">
					...
					<li><a href="<s:url action="PaidHolidayCalendar"/>" style="text-decoration:none;pointer:mouse;color:pink">Paid Holiday Calender
</a></li>
...
<center><h2>Paid Holiday Calander</h2></center>
