...
<a href="<s:url action="WorkingTime"/>" style="text-decoration:none;pointer:mouse;color:white;"><h3>Working Time </h3></a>
</div>
...
<a href="<s:url action="AttendanceQuery"/>" style="text-decoration:none;pointer:mouse;color:white;"><h3>Attendance Query</h3></a>
</div>
...
<a href="<s:url action="LeaveOverview"/>" style="text-decoration:none;pointer:mouse;color:white;"><h3>Leave Overview or Request</h3></a>

</div>
                        
<div style="height:2px;width:250px;float:left; margin-top:20%;margin-left:1%">              
<!--  <a href="Leave_inhancement.jsp" style="text-decoration:none;pointer:mouse;color:white;"><h3>Leave Inhancement</h3></a></b> -->
 <a href="<s:url action="LeaveEnhancement"/>" style="text-decoration:none;pointer:mouse;color:white;"><h3>Leave Enhancement</h3></a></b>
</div>

<div style="height:2px;width:250px;float:left; margin-top:20%;margin-left:1%">
<!-- <a href="paid_holiday_calendar.jsp" style="text-decoration:none;pointer:mouse;color:white;"><h3>Paid Holiday Calendar</h3></a></b> -->
<a href="<s:url action="PaidHolidayCalendar"/> " style="text-decoration:none;pointer:mouse;color:white;"><h3>Paid Holiday Calendar</h3></a></b>
