		...
		<div class="accordion">
			<div class="accordion-section">
				...
				<div id="accordion-1" class="accordion-section-content">
					<ul>
					<li><a href="<s:url action="Personal_Info"/>" style="text-decoration:none;pointer:mouse"> Personal information</a> </li>
					<li><a href="<s:url action="Personal_profile"/>" style="text-decoration:none;pointer:mouse;color:pink">Personal profile</a></li>
					<li><a href="<s:url action="Personal_qualification"/>" style="text-decoration:none;pointer:mouse"> Qualification</a></li>
					<li><a href="<s:url action="Previous_emp"/>" style="text-decoration:none;pointer:mouse"> Previous Employer</a></li>
