...
System.out.println("jsp name55555"+empLname);
/* if(empLname==null || empLname==""){
	empLname=" ";
	System.out.println("jsp name inside if5"+empLname);
} */
...
<div id="opted"  style="background-color: #F2F5F7; color:#FF0000;margin-top:3px;float:left;padding-left:15px; width:32%; ">HOME LOAN COMPONENT NOT OPTED</div><br><br></br></br>
<div id="intheading"style="background-color: #98c3e2;margin-top:-29px;float:left;padding-left:15px; width:80%;">Interest on Home Loan Details</div>

<table id="tab1" style="background-color:#FFFFFF; width:80%; border:1; cellpadding:0px;float:left;"  class = "tableStyle1" >
  <tr>
   <!--  <td class="headind_1"> -->
   ...
   <td> &nbsp; </td><td>&nbsp;</td>
					...
					//out.println("year======="+date[2]);
						%>
 <tr>
 <td> Period Name  : </td><td><input  name="basepay" id="basepay" style="background-color: #FFFFFF;border:0px;width:18%;" value="01-Apr-<%=fy_start %>" readonly="readonly"></input>&nbsp;To:&nbsp; <input  name="basepay" id="basepay" style="background-color: #FFFFFF;border:0px;width:20%;" value="31-Mar-<%=fy_start %>" readonly="readonly"></input>  </td>
 <td> &nbsp; </td><td>&nbsp;</td>
 </tr>
...
<%-- 
<table style="background-color:#dfecf5; width:80%; border:1; cellpadding:0px;margin-top:-24px">
 <!--  <caption>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input id="passedamt10" type="text" style="background-color: #dfecf5;border:0px;" name="passedamt10" value="0" readonly="readonly"/></td>
