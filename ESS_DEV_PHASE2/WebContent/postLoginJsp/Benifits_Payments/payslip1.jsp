...
<%
	...
	%> 
	Month  : <select name="monthList" id="month" style="background-color: white;color:black; width:24%;height:20%">
					...
					%>
		Year : <input type="" id="year"  name="year" value="<%=date[2] %>"  style="background-color: white;color:black; width:15%;height:12%"  readonly="readonly"/>
		 <br> 
...
<table style="background-color:#FFFFFF; width:100%; border:1; cellpadding:0px;float:left; margin-top:2%;">
 ...
 <tr>
 <td> DEPARTMENT : </td><td><input  name="basepay" id="basepay" style="background-color: #FFFFFF;border:0px;width:50%;" value="" readonly="readonly"></input></td>
 <td>Bank Account No : </td><td><input  name="basepay" id="basepay" style="background-color: #FFFFFF;border:0px;width:45%;" value="123654789321606" readonly="readonly"></input></td>
  ...
  <tr>
  <td> LOCATION : </td><td><input  name="basepay" id="basepay" style="background-color: #FFFFFF;border:0px;width:60%;" value="" readonly="readonly"></input>
