...
<div id="accordion2">
  <h3 style="color:#FFFFFF;font-size:15px;BACKGROUND-COLOR:#FF1493;"><b>WHATS NEW IN ESS</b></h3>
<div> 

 <ul style="align:left">
<li ><a href="#WHATSNEW" id="WHATSNEW" style="text-decoration: None;color:#FFFFFF;" onclick="openPage(this.id);"><b>Whats New</b></a></li>
<li><a href="#NEWS" id="NEWS" style="text-decoration: None;color:#FFFFFF;"	onclick="openPage(this.id);"><b>News</b></a></li>
