...
function atndQryRslt(id) {
	...
	$(function() {	
		...
		// whats new
		$("#wtsn").click(function() {
			//alert("you can not access this link now");
	...
	function openPage(id) {
		...
		/* else if (id == "delBtn") {
			...
			dataString = "";
				...
				url = "postLoginJsp/Benifits_Payments/print_currnet_ctc.jsp";
				dataString = "";
				...
				var popupWindow =window.open('postLoginJsp/Benifits_Payments/form_16.jsp?',"_blank","directories=no, status=no, menubar=no, scrollbars=yes, resizable=no,width=800, height=680,top=200,left=200");
				url = "postLoginJsp/Benifits_Payments/form_16_home.jsp";
				dataString = "";

			}else if (id == "GUIDEF16") {
				var popupWindow =window.open('postLoginJsp/Benifits_Payments/guidelines_form_16.jsp?',"_blank","directories=no, status=no, menubar=no, scrollbars=yes, resizable=no,width=800, height=680,top=200,left=200");
...
<body style="height:0px">
	...
	<!-- Project Switcher Button -->
        ...
        <!-- Top Navigation Bar -->
		<!--   background:#63A2CF -->
		<div class="container"  style="background:#DB0404; border-bottom:2px solid #4D7496;">
	<!-- Top Left Menu -->
			<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
                ...
                <li>
					<div id="ms" style="cursor:pointer;width:170px; ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Manager Services
					</div>
				</li>
                <li>
					<div id="elc" style="cursor:pointer;width:170px; back ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Employee life cycle
					</div>
				</li>
                
                  <li>
					 <div id="hrd" style="cursor:pointer;width:170px; ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HR Dashboard
					</div> 
	...
	<!-- Top Left Menu -->
			...
			<li>
					...
					<div id="wtsn" style="cursor:pointer;width:117px ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Whats New&nbsp;&nbsp;</div> 
				</li>
				...
				<li>
					...
					<div id="info" style="cursor:pointer;width:152px ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Personal Information&nbsp;&nbsp;</div> 
				</li>
                <li>
					<div id="eoff" style="cursor:pointer;width:130px ">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Employee offers
					</div>
				</li>
                <li>
					<%-- <a href="<s:url action="attandenceMenuAction" />" style="text-decoration:none;pointer:mouse;color:white">Attendance/Leave</a> --%>
					<div id="atnd" style="cursor:pointer;width:135px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Attendance/Leave</div> 	
				</li>
                
                  <li>
					<div id="bpay" style="cursor:pointer;width:146px ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Benifits & Payments
					</div>
				</li>
				...
				<li class="dropdown">
					<div id="tmgmt" style="cursor:pointer;width:145px ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Travel Managment
						<!-- <i class="icon-caret-down small"></i> -->
					</div>
					<!-- <ul class="dropdown-menu">
				 ...
				 <li>
					<div id="reimb" style="cursor:pointer;width:140px ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reimbursements
					</div>
				</li>
				
				 <li>
					<div id="ins" style="cursor:pointer;width:111px ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Insurance
					</div>
				</li>
				
				 <li>
					<div id="rbfs" style="cursor:pointer;width:125px ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Retiral Benifits
					</div>
				</li>
				
				 <li>
					<div id="ffs" style="cursor:pointer;width:129px ">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;F&F Settelement
					</div>
				</li>
