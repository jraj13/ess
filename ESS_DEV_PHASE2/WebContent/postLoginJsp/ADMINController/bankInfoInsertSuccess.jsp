...
String msg="";
	...
	String RegQry = "INSERT INTO BANKINFO(NAME ,EMP_ID,DESIGNATION,DEPARTMENT,LOCATION,PAN_NO,PF_NO,DOJ,BANK_NAME,ACC_NO) VALUES('"+ename+"','" +empid+ "','"+desing+"','" +dept + "','"+loc+"','" +panno + "','" +pfno + "', '"+doj1+"','"+bankname+"', '"+acntno+"')";
	 System.out.println("BANKINFO....."+RegQry);
		try {
			...
			if (rs > 0) {
				System.out.println("successfully BANKINFO inserted ");
				msg = "Bank Info successfully inserted";
