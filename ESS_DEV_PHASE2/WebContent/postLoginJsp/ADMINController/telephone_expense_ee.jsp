	...
	$(function() {
		$('#submit').click(function() {
							...
							if (bill_date == "") {
								...
								//docuement.getElementById('duedate').value="";
								return false;
							} 
								...
								$.ajax({
											url : 'postLoginJsp/ADMINController/telephone_expense_ee_save.jsp',
											type : 'POST',
											data : dataString,
											datatype : 'json',
											success : function(data) {
...
<SCRIPT TYPE="text/javascript">
	...
	function addRow_tt(in_tbl_name) {
		...
		var strHtml4 = "<input type=\"text\" name=\"bill_no\" id=\"bill_no\" value=\"\"   style=\"background-color: white;width:100%;\" class=\"requiredField\" />";
		td4.innerHTML = strHtml4.replace(/!count!/g, count);
		// create table cell 5
		var td5 = document.createElement("TD")
		var strHtml5 = "<input type=\"date\" name=\"bill_date\" id=\"bill_date\" value=\"\"   style=\"background-color: white;width:100%;\" class=\"requiredField\" />";
		td5.innerHTML = strHtml5.replace(/!count!/g, count);
		// create table cell 6
		var td6 = document.createElement("TD")
		var strHtml6 = "<input type=\"date\" name=\"duedate\" id=\"duedate\" value=\"\"   style=\"background-color: white;width:100%;\" class=\"requiredField\" />";
		...
		var strHtml9 = "<input type=\"text\" name=\"amount\" id=\"amount\" value=\"\"   style=\"background-color: white;width:100%;\" class=\"requiredField\"  />";
		...
		var strHtml16 = "<input type=\"text\" name=\"remarks\" id=\"remarks\" value=\"\"   style=\"background-color: white;width:100%;\" class=\"requiredField\" />";
		td16.innerHTML = strHtml16.replace(/!count!/g, count);
		// create table cell 16
		 var td17 = document.createElement("TD")
		 var strHtml17 = "<INPUT TYPE=\"Button\" CLASS=\"Button\" onClick=\"delRow()\" VALUE=\"Delete Row\" STYLE=\"height:24;width:85px;\">";
		 td17.innerHTML = strHtml17.replace(/!count!/g,count); 
		// append data to row
		/*   row.appendChild(td1); */
		row.appendChild(td2);
		row.appendChild(td3);
...
<h2 style="background-color: skyblue;margin-left:-3.5%;padding-left:15px;width:929px;"><b><%=selected_item %> Detail form</b></h2>
<br>
...
<td width="10%"><b>&nbsp;</b></td>
						...
						<tr >
								...
								<td width="10%"><input type="text" name="amount" id="amount" 	value=""  style="background-color: white;width:100%" onkeypress="return isAmount(event);"/></td>
								...
								<td style="border-spacing: 0px;border-style: none; border:1;"width="8%"><input type="hidden"  name="hiddenfield" id="hiddenfield" value=""  style="background-color: white;width:100%"/></td>
								</tr> 
