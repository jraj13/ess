...
try {
		String id =request.getParameter("sid"); 
			...
			System.out.println("sid for Rejection leave...."+id);  
		...
		String RegQry="update CALENDAR_LEAVE_APPLY_TEST set STATUS='Rejected' where SID="+id+"";
		
		System.out.println("Rejection query...."+RegQry);
		...
		System.out.println("rs.."+rs);
			...
			System.out.println("Rejection Leave=="+ex.getMessage());
		}
		finally{
			//out.println(message);
		}
...
<div id="leaveOverview">
	<table align="center">
		...
		System.out.println("reject..page size.."+leaveOV.size());
			if (leaveOV.size() > 0) {
