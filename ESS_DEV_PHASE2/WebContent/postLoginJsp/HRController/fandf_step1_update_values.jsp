...
<body>
<%
System.out.println("THis is updating the f and f sheet1 jsp page");
...
WorkSheet_FandF fandf_insert=new WorkSheet_FandF();
 ...
 String result=fandf_insert.update_step1(basic_salary,convey_allowance,hra,spa,fuel_maint,
