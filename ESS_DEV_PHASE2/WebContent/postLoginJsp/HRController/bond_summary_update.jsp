...
System.out.println("come in bond update succes page");
...
String bond_update_result=fnf_update.bond_update_save(favorite);

System.out.println("status in bond update succes page:::::::::::::::::::"+bond_update_result);

//out.println(bond_update_result);
