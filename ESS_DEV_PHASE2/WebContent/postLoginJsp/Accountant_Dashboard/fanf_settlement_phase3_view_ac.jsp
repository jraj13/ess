...
"&incometax=" + incometax+"&labour_welfare=" + labour_welfare+ "&esic=" + esic+ "&lease_car_emi=" +lease_car_emi+"&residual_value=" + residual_value+
 ...
 "&net_amount=" + net_amount + "&remarks="+remarks + "&status="+status;
				...
				$.ajax({
					url : 'postLoginJsp/Accountant_Dashboard/fandf_phase3_update_ac.jsp',
					type : 'POST',
					data : final_data,
					datatype : 'json',
...
<div 
			...
			<button type="button" value="<%=seq_no %>" id="fnf_settlement_back_ac" onclick="openPage(id)"
			...
			<button type="button" value="Settlement Done" id="fnfworksheet_save" 
	...
	<table id="fnfworksheet_table_1"
		...
		<tr>
			...
			<tr>
			<td style="padding-left:12px;"><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:135px;" disabled="disabled"/></td>
	...
	<table id="fnfworksheet_table_2"
		...
		<tr>
			<td><input type="text" id="basic_salary" style="height: 26px;width:126px;" value="<%=basic_salary%>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="convey_allowance" style="height: 26px;width:126px;" value="<%=convey_allowance %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="hra" style="height: 26px;width:126px;" value="<%=hra %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="spa" style="height: 26px;width:126px;" value="<%=spa %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="fuel_maint" style="height: 26px;width:126px;" value="<%=fuel_maint %>" disabled="disabled"/></td>
			</tr>
			
			
			
			<tr>
			<td><input type="text" id="education"  style="height: 26px;width:126px;" value="<%=education %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="hostel"  style="height: 26px;width:126px;" value="<%=hostel %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="medical"  style="height: 26px;width:126px;" value="<%=medical %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="one_time_payment"  style="height: 26px;width:126px;" value="<%=one_time_payment %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="lta_amount"  style="height: 26px;width:126px;" value="<%=lta_amount %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="bonus_exgratia_amount"  style="height: 26px;width:126px;" value="<%=bonus_exgratia_amount %>" disabled="disabled"/></td>
			</tr>
			
			
			<tr>
			<td><input type="text" id="advance"  style="height: 26px;width:126px;" value="<%=advance %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="washing"  style="height: 26px;width:126px;" value="<%=washing %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="entertainment"  style="height: 26px;width:126px;" value="<%=entertainment %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="travel_fuel_expenses"  style="height: 26px;width:126px;" value="<%=travel_fuel_expenses %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="food"  style="height: 26px;width:126px;" value="<%=food %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="gift"  style="height: 26px;width:126px;" value="<%=gift %>" disabled="disabled"/></td>
			</tr>
			...
			<tr>
			<td><input type="text" id="pl_encash" style="height: 26px;width:126px;" value="<%=pl_encash %>" disabled="disabled"/></td>
			</tr>
			
			<tr>
			<td><input type="text" id="el_encash" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=el_encash %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="sl_encash" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=sl_encash %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="actual_reimburse" style="height: 26px;width:126px;" value="<%=actual_reimburse %>" disabled="disabled"/></td>
			</tr>
			
			<tr>
			<td><input type="text" id="hold_salary" style="height: 26px;width:126px;" value="<%=hold_salary %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="" value="0.0" style="height: 26px;width:126px;" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="" value="0.0" style="height: 26px;width:126px;" disabled="disabled"/></td>
			</tr>
	...
	<table id="fnfworksheet_table_4"
		...
		<caption style="background-color: #98c3e2;"><b>Deductions(Rs)</b></caption>
		<tr>
			<td><input type="text" id="pf" style="height: 26px;width:126px;" value="<%=pf %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="profession_tax" style="height: 26px;width:126px;" value="<%=profession_tax %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="ess_claim" style="height: 26px;width:126px;" value="<%=ess_claim %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="notice_period" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=notice_period %>" disabled="disabled"/></td>
			</tr>
			
			
			
			<tr>
			<td><input type="text" id="mariage_loan"  style="height: 26px;width:126px;" value="<%=mariage_loan %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="personal_loan" style="height: 26px;width:126px;" value="<%=personal_loan %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="medical_loan" style="height: 26px;width:126px;" value="<%=medical_loan %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="medical_reim_recovery"  style="height: 26px;width:126px;" value="<%=medical_reim_recovery %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="fuel_maint_recovery"  style="height: 26px;width:126px;" value="<%=fuel_maint_recovery %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="joining_bonus"  style="height: 26px;width:126px;" value="<%=joining_bonus %>" disabled="disabled"/></td>
			</tr>
			
			
			
			<tr>
			<td><input type="text" id="house_shift"  style="height: 26px;width:126px;" value="<%=house_shift %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="black_berry"  style="height: 26px;width:126px;" value="<%=black_berry %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="retemtion_bonus" style="height: 26px;width:126px;" value="<%=retemtion_bonus %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="salary_advance"  style="height: 26px;width:126px;" value="<%=salary_advance %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="domestic_travel"  style="height: 26px;width:126px;" value="<%=domestic_travel %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="foreign_travel"  style="height: 26px;width:126px;" value="<%=foreign_travel %>" disabled="disabled"/></td>
			</tr>
			...
			<tr>
			<td><input type="text" id="impress" style="height: 26px;width:126px;" value="<%=impress %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="id_card" style="height: 26px;width:126px;" value="<%=id_card %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="notice_peroid_previous" style="height: 26px;width:126px;" value="<%=notice_peroid_previous %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="white_goods_recovery" style="height: 26px;width:126px;" value="<%=white_goods_recovery %>" disabled="disabled"/></td>
			</tr>
			
			<tr>
			<td><input type="text" id="incometax"  style="height: 26px;width:126px;" value="<%=incometax %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="labour_welfare"  style="height: 26px;width:126px;" value="<%=labour_welfare %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="esic"  style="height: 26px;width:126px;" value="<%=esic %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="lease_car_emi"  style="height: 26px;width:126px;" value="<%=lease_car_emi %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="residual_value"  style="height: 26px;width:126px;" value="<%=residual_value %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="excess_cl_recovery"  style="height: 26px;width:126px;" value="<%=excess_cl_recovery %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="bmp_recovery"  style="height: 26px;width:126px;" value="<%=bmp_recovery %>" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="" value="" style="height: 26px;width:126px;" disabled="disabled"/></td>
			</tr>
			<tr>
			<td><input type="text" id="" value="" style="height: 26px;width:126px;" disabled="disabled"/></td>
			</tr>
...
<hr style="color:#000000;">
 ...
 <caption style="background-color: #98c3e2;"><b>Remarks</b><span style="color:red">*</span></caption>
		<tr><td>&nbsp;</td></tr>
		<tr>
