...
"&incometax=" + incometax+"&labour_welfare=" + labour_welfare+ "&esic=" + esic+ "&lease_car_emi=" +lease_car_emi+"&residual_value=" + residual_value+
 ...
 "&net_amount=" + net_amount + "&remarks="+remarks + "&status="+status;
				...
				$.ajax({
					url : 'postLoginJsp/SA_Dashbord/fandF_phse3_insert_values.jsp',
					type : 'POST',
					data : final_data,
					datatype : 'json',
...
System.out.println("SA_Dashbord fnf worksheet in full and final hr step3.." +seq_no);
WorkSheet_FandF sheet3=new WorkSheet_FandF();


ArrayList<String> data=sheet3.getting_initial_data_step3(seq_no);
if (data.size() > 0) {
...
<div 
			...
			<button type="button" value="Submitted to SA" id="fnfworksheet" 
	...
	<table id="fnfworksheet_table_1"
		...
		<tr>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=basic_salary %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Conveyance Allowance:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=convey_allowance %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Housing Rent Allowance(HRA):</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=hra %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Special Personal Allowance:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=spa %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Fuel and Maintenance:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=fuel_maint %>" /></td>
			</tr>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=education %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Children Hostel Allowance:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=hostel %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Medical Reimbursement:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=medical %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">One Time Payment:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=one_time_payment %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">LTA:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=lta_amount %>" /></td>
			</tr>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=bonus_exgratia_amount %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Advance Bonus:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=advance %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Washing Expense:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=washing %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Entertainment Expense:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=entertainment %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Travel/Fuel Expense:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=travel_fuel_expenses %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Food Coupens:</td>
			<td><input type="text" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=food %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Gift Coupens:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=gift %>"/></td>
			</tr>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=pl_encash %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">EL Encashment:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=el_encash %>" /></td>
			</tr>
			
			<tr>
			<td style="padding-left:12px;">SL Encashment:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;"  value="<%=sl_encash %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;">Actual Reimbursment Total:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=actual_reimburse %> "/></td>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=hold_salary %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:12px;"><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:135px;" /></td>
			<td><input type="text"  value="0.0" style="background-color: #dfecf5;height: 26px;width:126px;" /></td>
			</tr>
	...
	<table id="gratuty_tab" border="1" style="margin-top: 3px;margin-left: -3px;"><!--  style="margin-top: 3px; margin-left: -1.5%; padding-left: 15px; "> --> 
		...
		<td style="padding-left: 50px;" ><input type="text" id="cumulative_basic"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=basic_salary %>" /></td>
		</tr>
		<tr>
		<td style="padding-left:12px;">Total Gratuty/Exgratia</td>
		<td style="padding-left: 50px;"><input type="text" id="gratuty"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=gratuty %>" /></td>
		</tr>
		</table> 
		<br>
		...
		<td style="padding-left: 0px;" ><input type="text" id="non_taxable_leaves"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=non_taxable_leaves %>" /></td>
		</tr>
		</table> 
	...
	<table id="fnfworksheet_table_3"
		...
		<tr>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=pf %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Professional Tax:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=profession_tax %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">ESS Claim Recovery:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=ess_claim %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Notice Period:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=notice_period %>" /></td>
			</tr>
			...
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=mariage_loan %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Personal Loan:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=personal_loan %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Medical Loan:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=medical_loan %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Medical Reimb. Recovery:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=medical_reim_recovery %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Fuel&Maintainance Recovery:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=fuel_maint_recovery %>"/></td>
			</tr>
			...
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=joining_bonus %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">House Shift Allowance:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=house_shift %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">BlackBerry Handset Recovery:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=black_berry %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Retention Bonus:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=retemtion_bonus %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Salary Advance:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=salary_advance %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Domestic Travel Adv.:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=domestic_travel %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Foreign Travel Adv.:</td>
			<td><input type="text" id="" style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=foreign_travel %>"/></td>
			</tr>
			...
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=impress %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Identity Card:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=id_card %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Notice Pay to Previous Employer:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=notice_peroid_previous %>"/></td>
			</tr>
			
			<tr>
			<td style="padding-left:7px;">White goods recovery:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=white_goods_recovery %>" /></td>
			</tr>
			
			
			<tr>
			<td style="padding-left:7px;">Income Tax:</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=incometax %>"/></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Labour Welfare Fund</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=labour_welfare %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">ESIC</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=esic %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Lease Car EMI</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=lease_car_emi %>" /></td>
			</tr>
			
			<tr>
			<td style="padding-left:7px;">Residual Value</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=residual_value %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">Excess CL Recovery</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=excess_cl_recovery %>" /></td>
			</tr>
			<tr>
			<td style="padding-left:7px;">SMP Recovery</td>
			<td><input type="text"  style="background-color: #dfecf5;height: 26px;width:126px;" value="<%=bmp_recovery %>"/></td>
			</tr>
			<tr>
...
<br><br>
 ...
 <table  id="net_earnings" style= "width: 100%;margin-left: -3px;margin-top: 160px">
	 <caption style="background-color: #98c3e2;margin-top: 44px"><b>Net Earnings and Deductions</b></caption>
	<tr>
	<td colspan="2" style="padding-left: 12px;"><input type="button" id="reclaculate" style="background-color:#FFFF99;" value="Recalculate Net Amount"/></td>
		...
		<td><input type="text"  id="total_earnings" style="height: 26px;width:126px;" value="<%=total_earnings%>"/></td>
		</tr>
		<tr>
		<td style="width:150px;padding-left: 12px;">Total Deductions(Rs) :</td>
		<td><input type="text"  id="total_deductions" style="height: 26px;width:126px;" value="<%=total_deductions %>" /></td>
		</tr>
		<tr>
		<td style="width:150px;padding-left: 12px;">Total Net Amount:</td>
		<td><input type="text"  id="net_amount" style="height: 26px;width:126px;" value="<%=net_amount %>"/></td>
		<tr>
...
<hr style="color:#000000;">
 ...
 <caption style="background-color: #98c3e2;"><b>Remarks*</b></caption>
		<tr><td>&nbsp;</td></tr>
		<tr>
		<td style="width:150px;padding-left:12px;"><textarea rows="3" cols="46" id="remarks"></textarea></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
