...
<div id="accordion2">
  <h3 style="color:#FFFFFF;font-size:15px;BACKGROUND-COLOR:#FF1493;"><b>Due Clearance</b></h3>
<div> 

 <ul style="align:left">
<li ><a href="#DUECLEARANCE_ELC" id="DUECLEARANCE_ELC" style="text-decoration: None;color:#FFFFFF;" onclick="openPage(this.id);"><b>Due Clearance</b></a></li>
</ul>
