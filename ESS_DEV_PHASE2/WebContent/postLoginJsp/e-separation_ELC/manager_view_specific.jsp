...
function fileUpload(form, action_url, div_id) {
    ...
    var eventHandler = function () {
            ...
            /* document.getElementById(div_id).innerHTML = "Uploaded Successfully"; */
		...
		$("#save").click(function() {
			...
			if(note=="" || comments_approve=="")
			 ...
			 if (confirm('Are you sure you want process this?')) {
				...
				var result_data="&sequence_id=" + sequence_id+"&emp_id=" + emp_id+ "&action=" + action+ "&reason_a=" +reason_a+"&detailed_a=" + detailed_a
...
<div id="accordion" style="width:1000px;">
 ...
 <td><input type="hidden" id="sequence_id" value="<%=seq_no %>"/></td>
 </tr>
  <tr>
  ...
  <td style="padding-left:5em;"> <input id="action" type="text" style="background-color:#C0DEF5;height:26px;" value="<%=reason_action %>" readonly="readonly" /> </td>
  </tr>
  ...
  <td style="padding-left:5em;"><input id="relieving_rm" type="date" style="background-color:white;height:26px;width:100%;" /> </td>
  </tr>
  ...
  <td style="padding-left:5em;"><input id="r_date" type="text" style="background-color:#C0DEF5;height:26px;" value="<%=rileaving_date %>" readonly="readonly" /> </td>
  </tr>
...
<%
 ...
 <!--  <h3 style="background-color: #C0DEF5">Attachments</h3>
  <div style="background-color: white !important;color: black;">
   Choose File:<input type="file" name="datafile" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"/>
<div style="padding-left:15em;"><input type="button" value="upload"
        onClick="fileUpload(this.form,'/UploadServlet','upload_data'); return false;" >
        </div>
<div id="upload_data"></div>
  </div> -->
</div>
 </div>
<div style="padding-left:25em;"><input type="submit" id="save" value="submit"/></div>
