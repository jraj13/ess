...
<div> 
 ...
 <ul style="align:left">
<li><a href="#EMP_SEARCH" id="EMP_SEARCH" style="text-decoration: None;color:#FFFFFF;" onclick="openPage(this.id);" title="Employee Search"><b>Employee Search</b></a></li>
<li><a href="#R_MATRIX" id="R_MATRIX" style="text-decoration: None;color:#FFFFFF;" onclick="openPage(this.id);" title="R-Matrix"><b>R-Matrix</b></a></li>
