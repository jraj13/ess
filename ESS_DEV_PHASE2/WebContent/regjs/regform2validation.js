...
var empdob = document.getElementById('dob');
var pan = document.getElementById('pannum');
var phone = document.getElementById('phnumone');
...
if (inputAlphabet(lastname, "*please use alphabets only")) {


if (textAlphanumeric(pan, "* For Address please use numbers and letters *")) {
if (textNumeric(phone, "* Please enter a valid zip code *")) {
if (emailValidation(email, "* Please enter a valid email address *")) {
if (trueSelection(maritalstatus, "* Please Choose any one option")) {
return true;
}
}
}
