...
//BASIC TEXT BOX VALIDATION

function isbasic(evt) { 
    var charCode = (evt.charCode) ? evt.which : event.keyCode
    ...
    var input = document.getElementById("basic").value;
        var len = document.getElementById("basic").value.length; 
        var index = document.getElementById("basic").value.indexOf('.'); 
...
function medical()
{
	...
	if(Number(mr2)>15000)
	{
		alert("Enter with in a medical Reimursement range");
		...
		document.getElementById('mr2').value='0';
			...
			{
		alert("Please Enter with in Available Choice Pay Amount");
		document.getElementById("mr2").focus();
		document.getElementById('mr2').value='0';
			}
	else
...
function issp(evt) { 
      ...
      var input = document.getElementById("sp").value;
          var len = document.getElementById("sp").value.length; 
          var index = document.getElementById("sp").value.indexOf('.'); 
...
function ispf(evt) { 
      ...
      var input = document.getElementById("pf").value;
          var len = document.getElementById("pf").value.length; 
          var index = document.getElementById("pf").value.indexOf('.'); 
...
//gratuity text box validation

function isgratuity(evt) { 
    var charCode = (evt.charCode) ? evt.which : event.keyCode
    ...
    var input = document.getElementById("gratuity").value;
        var len = document.getElementById("gratuity").value.length; 
        var index = document.getElementById("gratuity").value.indexOf('.'); 
...
function isesi(evt) { 
    ...
    var input = document.getElementById("esi").value;
        var len = document.getElementById("esi").value.length; 
        var index = document.getElementById("esi").value.indexOf('.'); 
...
function ispli(evt) { 
    ...
    var input = document.getElementById("pli").value;
        var len = document.getElementById("pli").value.length; 
        var index = document.getElementById("pli").value.indexOf('.'); 
...
/* FOR LEAVES CONFIGURATION VALIDATION  */
...
function isPL(evt) { 
    ...
    var input = document.getElementById("pl").value;
        var len = document.getElementById("pl").value.length; 
        var index = document.getElementById("pl").value.indexOf('.'); 
...
function isSL(evt) { 
    ...
    var input = document.getElementById("sl").value;
        var len = document.getElementById("sl").value.length; 
        var index = document.getElementById("sl").value.indexOf('.'); 
...
function isCL(evt) { 
    ...
    var input = document.getElementById("cl").value;
        var len = document.getElementById("cl").value.length; 
        var index = document.getElementById("cl").value.indexOf('.'); 
...
function isAdvancePL(evt) { 
    var charCode = (evt.charCode) ? evt.which : event.keyCode

    if (charCode > 31 && (charCode < 48 || charCode > 57) && charCode != 46) 
        return false; 
    else { 
    var input = document.getElementById("advpl").value;
        var len = document.getElementById("advpl").value.length; 
        var index = document.getElementById("advpl").value.indexOf('.'); 
...
function isAdvanceSL(evt) { 
    var charCode = (evt.charCode) ? evt.which : event.keyCode

    if (charCode > 31 && (charCode < 48 || charCode > 57) && charCode != 46) 
        return false; 
    else { 
    var input = document.getElementById("advsl").value;
        var len = document.getElementById("advsl").value.length; 
        var index = document.getElementById("advsl").value.indexOf('.'); 
...
function isCompOff(evt) { 
    var charCode = (evt.charCode) ? evt.which : event.keyCode

    if (charCode > 31 && (charCode < 48 || charCode > 57) && charCode != 46) 
        return false; 
    else { 
    var input = document.getElementById("compoff").value;
        var len = document.getElementById("compoff").value.length; 
        var index = document.getElementById("compoff").value.indexOf('.'); 
